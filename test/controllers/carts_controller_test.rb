...
class CartsControllerTest < ActionController::TestCase
  ...
  test "if no order ID is stored in the session, update should not alter the record and should redirect to the index with an error method" do
    session[:order] = nil
    put :update, {order: {name: 'Bill the Cat', address: 'Bloom Boarding House', email: 'bill@thecat.com', city: 'Bloom County', state: 'NA', zip: '00000', card_name: "Berkeley Breathed", card_num: '0000000000000000', cvv: '111', billing_zip: '00000', expiry: Date.today.to_s}}
    assert_response :redirect
